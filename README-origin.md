...
**English** · [简体中文](./README-origin.zh.md)
...
> Archived from the upstream project: [feiyang-dev/dsh-usage-plugin](https://github.com/feiyang-dev/dsh-usage-plugin). This file is kept for reference; the upstream repository remains the authoritative source.
