window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var st = {
      ...
      tab: { padding: "16px 20px", maxWidth: 1100, margin: "0 auto" },
      ...
      btn: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 6, padding: "4px 10px", fontSize: 12, cursor: "pointer", color: "inherit" },
      btnPrimary: { border: "1px solid rgba(90,140,255,.6)", background: "rgba(90,140,255,.22)", borderRadius: 6, padding: "4px 10px", fontSize: 12, cursor: "pointer", color: "inherit" },
      btnDisabled: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 6, padding: "4px 10px", fontSize: 12, cursor: "default", color: "inherit", opacity: 0.5 },
      input: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 6, padding: "4px 10px", fontSize: 12, color: "inherit", minWidth: 280 },
      dateInput: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 6, padding: "3px 8px", fontSize: 12, color: "inherit" },
      ...
      segBtnOn: { border: 0, background: "rgba(90,140,255,.22)", padding: "4px 10px", fontSize: 12, cursor: "pointer", color: "inherit", fontWeight: 600 },
      cards: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(150px,1fr))", gap: 10 },
      card: { border: "1px solid rgba(128,128,128,.35)", borderRadius: 8, padding: "10px 12px" },
      cardL: { fontSize: 11, opacity: 0.6, marginBottom: 4 },
      cardV: { fontSize: 18, fontWeight: 600 },
      cardH: { fontSize: 10, opacity: 0.5, marginTop: 2 },
      sec: { fontSize: 13, fontWeight: 600, marginTop: 6 },
      subtabBar: { display: "flex", gap: 6, borderBottom: "1px solid rgba(128,128,128,.2)", paddingBottom: 8, flexWrap: "wrap" },
      subtab: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 6, padding: "5px 14px", fontSize: 12, cursor: "pointer", color: "inherit" },
      subtabOn: { border: "1px solid rgba(90,140,255,.5)", background: "rgba(90,140,255,.22)", borderRadius: 6, padding: "5px 14px", fontSize: 12, cursor: "pointer", color: "inherit", fontWeight: 600 },
      scroll: { overflowX: "auto" },
      tbl: { width: "100%", borderCollapse: "collapse", fontSize: 12 },
      th: { textAlign: "right", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap", opacity: 0.55, fontWeight: 500 },
      thFirst: { textAlign: "left", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap", opacity: 0.55, fontWeight: 500 },
      td: { textAlign: "right", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap" },
      tdFirst: { textAlign: "left", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap" },
      tdTotal: { textAlign: "right", padding: "6px 8px", fontWeight: 600, borderTop: "1px solid rgba(128,128,128,.35)" },
      tdTotalFirst: { textAlign: "left", padding: "6px 8px", fontWeight: 600, borderTop: "1px solid rgba(128,128,128,.35)" },
      tdClick: { textAlign: "left", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap", cursor: "pointer" },
      tdClickSel: { textAlign: "left", padding: "6px 8px", borderBottom: "1px solid rgba(128,128,128,.2)", whiteSpace: "nowrap", cursor: "pointer", color: "#5a8cff", fontWeight: 600 },
      badgeHit: { display: "inline-block", padding: "2px 8px", borderRadius: 999, fontSize: 11, fontWeight: 500, background: "rgba(46,204,113,.18)", color: "#2ecc71" },
      badgePeak: { display: "inline-block", padding: "2px 8px", borderRadius: 999, fontSize: 11, fontWeight: 500, background: "rgba(255,152,0,.18)", color: "#ff9800" },
      badgeValley: { display: "inline-block", padding: "2px 8px", borderRadius: 999, fontSize: 11, fontWeight: 500, background: "rgba(90,140,255,.18)", color: "#5a8cff" },
      err: { color: "#ff6b6b", fontSize: 12 },
      empty: { fontSize: 12, opacity: 0.6, padding: "16px 0" },
      note: { fontSize: 11, opacity: 0.55 },
      errbox: { border: "1px solid rgba(255,107,107,.4)", background: "rgba(255,107,107,.08)", borderRadius: 8, padding: 12, fontSize: 12 },
      ...
      heroLabel: { fontSize: 12, opacity: 0.85 },
      heroValue: { fontSize: 32, fontWeight: 700, letterSpacing: 0.5 },
      heroCurrency: { fontSize: 12, opacity: 0.9 },
      ...
      calWk: { textAlign: "center", fontSize: 11, opacity: 0.5, padding: "2px 0" },
      calCell: { border: "1px solid rgba(128,128,128,.15)", borderRadius: 6, padding: "6px 2px", textAlign: "center", fontSize: 12, cursor: "pointer", minHeight: 40, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2 },
      calCellBlank: { border: "1px solid transparent", padding: "6px 2px", minHeight: 40 },
      calCellOn: { outline: "2px solid #5a8cff", outlineOffset: -2 },
      calCellVal: { fontSize: 10, opacity: 0.8, maxWidth: "100%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
      legend: { display: "flex", alignItems: "center", gap: 6, fontSize: 11, opacity: 0.65, marginTop: 8, flexWrap: "wrap" },
      ...
      numInput: { border: "1px solid rgba(128,128,128,.35)", background: "transparent", borderRadius: 4, padding: "3px 6px", fontSize: 12, color: "inherit", width: 78, textAlign: "right" },
      selDayTitle: { fontSize: 13, fontWeight: 600, marginTop: 14 }
    };
    ...
    function drawReport(canvas, records) {
      ...
      var W = 1400, P = 40, count = records.length;
      ...
      var totalHit = 0, totalMiss = 0, totalWrite = 0, totalOut = 0, totalReason = 0, totalCost = 0;
      for (var i = 0; i < count; i++) {
        var r = records[i];
        totalHit += r.cacheReadTokens || 0; totalMiss += r.inputTokens || 0; totalWrite += r.cacheWriteTokens || 0;
        totalOut += r.outputTokens || 0; totalReason += r.reasoningTokens || 0; totalCost += (r.peakValleyCost || 0);
      }
      var hitRate = (totalHit + totalMiss + totalWrite) > 0 ? (totalHit / (totalHit + totalMiss + totalWrite) * 100).toFixed(1) + "%" : "—";
      var byModel = {};
      for (var i2 = 0; i2 < count; i2++) {
        var r2 = records[i2];
        var mk = r2.modelKey || "unknown";
        if (!byModel[mk]) byModel[mk] = { key: mk, calls: 0, hit: 0, miss: 0, out: 0, reason: 0, cost: 0 };
        byModel[mk].calls += 1; byModel[mk].hit += r2.cacheReadTokens || 0; byModel[mk].miss += r2.inputTokens || 0;
        byModel[mk].out += r2.outputTokens || 0; byModel[mk].reason += r2.reasoningTokens || 0; byModel[mk].cost += (r2.peakValleyCost || 0);
      }
      var modelRows = [];
      for (var k in byModel) modelRows.push(byModel[k]);
      modelRows.sort(function (a, b) { return a.key < b.key ? -1 : a.key > b.key ? 1 : 0; });

      var H = 244 + headH + count * rowH + 24 + 18 + headH + (modelRows.length + 1) * rowH + 26 + 44;
      if (H > 30000 && rowH > 12) { rowH = 12; fBase = 10; headH = 14; H = 244 + headH + count * rowH + 24 + 18 + headH + (modelRows.length + 1) * rowH + 26 + 44; }
      ...
      ctx.fillText("生成时间 " + fmtTime(Date.now()) + "（北京） · 共 " + count + " 条调用 · 缓存命中率 " + hitRate + " · 峰谷价总消耗 " + fmtMoney(totalCost) + (totalIn > count ? " · 报告仅含最近 " + count + " 条" : ""), P, 92);

      var cardW = (W - 2 * P - 4 * 15) / 5;
      var cards = [
      ...
      var c1 = { time: P, model: P + 150, missR: P + 460, hitR: P + 570, writeR: P + 670, outR: P + 770, reasonR: P + 870, rateR: P + 970, periodR: P + 1050, endR: P + 1180, costR: P + 1360 };
      var y = 226;
      ...
      for (var r3 = 0; r3 < count; r3++) {
        ...
        ctx.fillText(fmtTime(rec.time), c1.time, ty); ctx.fillText(modelLabel(rec.modelKey), c1.model, ty);
        ctx.textAlign = "right";
        ...
        ctx.fillStyle = "#1c2733"; ctx.fillText(fmtMoney(cost), c1.costR, ty);
        y += rowH;
      }

      y += 24;
      ctx.textAlign = "left"; ctx.fillStyle = "#1c2733"; font(15, "600");
      ctx.fillText("消耗表（按模型 · 峰谷价）", P, y);
      y += 18;
      var c2 = { model: P, callsR: P + 360, missR: P + 540, hitR: P + 720, outR: P + 900, reasonR: P + 1080, costR: P + 1360 };
      ctx.fillStyle = "#eef1f5"; ctx.fillRect(P, y, W - 2 * P, headH);
      ctx.fillStyle = "#55617a"; font(fBase + 1, "600");
      ...
      ctx.fillText("输出", c2.outR, hty2); ctx.fillText("推理", c2.reasonR, hty2); ctx.fillText("消耗", c2.costR, hty2);
      y += headH;
      var t2rows = modelRows.concat([{ key: "合计", calls: count, miss: totalMiss, hit: totalHit, out: totalOut, reason: totalReason, cost: totalCost }]);
      for (var m = 0; m < t2rows.length; m++) {
        ...
        ctx.fillText(isTotal ? "合计" : modelLabel(row.key), c2.model, ty2);
        ctx.textAlign = "right";
        ...
        ctx.fillText(fmtMoney(row.cost), c2.costR, ty2);
        y += rowH;
      }
      y += 26;
      ctx.textAlign = "left"; ctx.fillStyle = "#98a2b3"; font(11, "400");
      ctx.fillText("价格：峰谷价 · 高峰时段（北京 9:00–12:00、14:00–18:00）· 单位：元 / 百万 tokens · 由 dsh-usage-plugin 生成", P, y);
    }
    ...
    function OverviewView(props) {
      ...
      for (var i = 0; i < records.length; i++) {
        ...
        totalCost += cost;
        var mk = r.modelKey || "unknown";
        if (!byModel[mk]) byModel[mk] = { key: mk, calls: 0, hit: 0, miss: 0, out: 0, reason: 0, cost: 0 };
        byModel[mk].calls += 1; byModel[mk].hit += r.cacheReadTokens || 0; byModel[mk].miss += r.inputTokens || 0;
        byModel[mk].out += r.outputTokens || 0; byModel[mk].reason += r.reasoningTokens || 0; byModel[mk].cost += cost;
      }
      var hitRate = (totalHit + totalMiss + totalWrite) > 0 ? (totalHit / (totalHit + totalMiss + totalWrite) * 100).toFixed(1) + "%" : "—";
      var modelRows = [];
      for (var k in byModel) modelRows.push(byModel[k]);
      ...
      return el("div", null,
        el("div", { style: st.cards },
          el(Card, { label: "调用次数", value: fmtInt(totalCalls), hint: "" }),
          ...
          el(Card, { label: "总消耗", value: fmtMoney(totalCost), hint: regimeLabel(regime) })
        ),
        el("div", { style: st.sec }, "消耗表（按模型）"),
        el("div", { style: st.scroll },
          el("table", { style: st.tbl },
            el("thead", null, el("tr", null,
              el("th", { style: st.thFirst }, "模型"), el("th", { style: st.th }, "调用"), el("th", { style: st.th }, "输入·未命中"), el("th", { style: st.th }, "缓存命中"), el("th", { style: st.th }, "输出"), el("th", { style: st.th }, "推理"), el("th", { style: st.th }, "消耗")
            )),
            el("tbody", null,
              modelRows.map(function (m) {
                return el("tr", { key: m.key },
                  el("td", { style: st.tdFirst }, modelLabel(m.key)),
              ...
              el("tr", null,
                el("td", { style: st.tdTotalFirst }, "合计"), el("td", { style: st.tdTotal }, fmtInt(totalCalls)), el("td", { style: st.tdTotal }, fmtInt(totalMiss)), el("td", { style: st.tdTotal }, fmtInt(totalHit)), el("td", { style: st.tdTotal }, fmtInt(totalOut)), el("td", { style: st.tdTotal }, totalReason ? fmtInt(totalReason) : "—"), el("td", { style: st.tdTotal }, fmtMoney(totalCost))
              )
            )
          )
        ),
        el("div", { style: st.note, marginTop: 8 }, "高峰时段（北京时间 9:00–12:00、14:00–18:00）按高峰价，其余时段按空闲价（高峰价的一半），系统按每次调用发生的时间自动选择档位。单位：元 / 百万 tokens。")
      );
    }
    ...
    function CalendarView(props) {
      ...
      var maxV = 0, monthCalls = 0, monthMiss = 0, monthHit = 0, monthOut = 0, monthCost = 0;
      for (var d2 = 1; d2 <= nDays; d2++) {
        ...
        if (v2 > maxV) maxV = v2;
        if (r2) {
          monthCalls += r2.calls; monthMiss += r2.miss; monthHit += r2.hit; monthOut += r2.out; monthCost += dayCost(r2);
        }
      }
      ...
      return el("div", null,
        el("div", { style: st.calBar },
          ...
          el("span", { style: { fontSize: 14, fontWeight: 600, minWidth: 120, textAlign: "center" } }, y + "年" + (m + 1) + "月"),
        ...
        el("div", { style: st.cards, marginTop: 12 },
          el(Card, { label: "本月调用", value: fmtInt(monthCalls), hint: y + "年" + (m + 1) + "月" }),
          ...
          el(Card, { label: "本月消耗", value: fmtMoney(monthCost), hint: regimeLabel(regime) })
        ),
        ...
        monthRows.length === 0
          ...
          : el("div", { style: st.scroll },
              el("table", { style: st.tbl },
                el("thead", null, el("tr", null,
                  el("th", { style: st.thFirst }, "日期"), el("th", { style: st.th }, "调用"), el("th", { style: st.th }, "高峰/空闲"), el("th", { style: st.th }, "输入·未命中"), el("th", { style: st.th }, "缓存命中"), el("th", { style: st.th }, "输出"), el("th", { style: st.th }, "消耗(自动)"), el("th", { style: st.th }, "消耗(峰谷)"), el("th", { style: st.th }, "消耗(基础)")
                )),
                el("tbody", null, monthRows.map(function (drow) {
                  ...
                  return el("tr", { key: drow.day },
                    ...
                    el("td", { style: st.td }, fmtMoney(drow.autoCost)),
                    el("td", { style: st.td }, fmtMoney(drow.peakValleyCost)),
                    el("td", { style: st.td }, fmtMoney(drow.baseCost))
                  );
                }))
              )
            ),
          ...
          ? el("div", null,
              ...
              selRecords.length === 0
                ...
                : el("div", { style: st.scroll },
                    el("table", { style: st.tbl },
                      el("thead", null, el("tr", null,
                        el("th", { style: st.thFirst }, "时间(北京)"), el("th", { style: st.th }, "模型"), el("th", { style: st.th }, "输入·未命中"), el("th", { style: st.th }, "缓存命中"), el("th", { style: st.th }, "输出"), el("th", { style: st.th }, "推理"), el("th", { style: st.th }, "时段"), el("th", { style: st.th }, "结束"), el("th", { style: st.th }, "消耗")
                      )),
                      el("tbody", null, selRecords.map(function (rr) {
                        ...
                        return el("tr", { key: rr.time },
                          ...
                          el("td", { style: st.tdFirst }, modelLabel(rr.modelKey)),
    ...
    function CacheListView(props) {
      ...
      return el("div", null,
        el("div", { style: st.calBar },
          ...
          (fromDate || toDate) ? el("button", { style: st.btn, onClick: function () { setFromDate(""); setToDate(""); setPreset("all"); } }, "清除区间") : null
        ),
        el("div", { style: st.note, marginTop: 8 },
          "当前范围：共 " + fmtInt(filtered.length) + " 条 · 输入·未命中 " + fmtInt(sumMiss) + " · 缓存命中 " + fmtInt(sumHit) + " · 缓存写入 " + fmtInt(sumWrite) + " · 输出 " + fmtInt(sumOut) + " · 消耗 " + fmtMoney(sumCost) + "（" + costHint(regime) + "）"
        ),
        filtered.length === 0
          ...
          : el("div", { style: st.scroll },
              el("table", { style: st.tbl },
                el("thead", null, el("tr", null,
                  el("th", { style: st.thFirst }, "时间(北京)"), el("th", { style: st.th }, "模型"), el("th", { style: st.th }, "输入·未命中"), el("th", { style: st.th }, "缓存命中"), el("th", { style: st.th }, "缓存写入"), el("th", { style: st.th }, "输出"), el("th", { style: st.th }, "推理"), el("th", { style: st.th }, "命中率"), el("th", { style: st.th }, "时段"), el("th", { style: st.th }, "结束"), el("th", { style: st.th }, "消耗")
                )),
                el("tbody", null, filtered.map(function (rr3, idx) {
                  ...
                  return el("tr", { key: rr3.time + "-" + idx },
                    ...
                    el("td", { style: st.tdFirst },
                      el("div", null, modelLabel(rr3.modelKey)),
      ...
      return el("div", null,
        ...
        regime === "auto"
          ? el("div", { style: st.note, marginTop: 6 },
              "自动模式：按调用时间自动选择计费档位——新价格表生效前的调用按基础价（旧价格表），生效后的调用按峰谷价（高峰时段 9:00–12:00、14:00–18:00 用高峰价，其余空闲时段用空闲价）。当前价格表为官方最新公布价格，不可编辑。"
            )
          : null,
        ...
        el("div", { style: st.note, marginTop: 8 },
          "单位：元 / 百万 tokens。高峰时段为北京时间 9:00–12:00、14:00–18:00，其余为空闲时段（空闲价 = 高峰价的一半）。价格按官方公布固定，不可编辑。"
        )
      );
    }
    // ── Usage panel ──
    ...
    function UsagePanel(props) {
      ...
      React.useEffect(function () {
        refresh();
        if (timer && timer.interval) return timer.interval(refresh, 3000);
        return undefined;
      }, []);
      ...
      var segBtn0 = regime === "auto" ? st.segBtnOn : st.segBtn;
      var segBtn1 = regime === "peakValley" ? st.segBtnOn : st.segBtn;
      var segBtn2 = regime === "base" ? st.segBtnOn : st.segBtn;
      ...
      return el("div", { style: st.root },
        ...
        el("div", { style: st.head },
          ...
          el("div", { style: st.actions },
            el("div", { style: st.seg },
              el("button", { style: segBtn0, onClick: function () { setRegime("auto"); } }, "自动"),
              el("button", { style: segBtn1, onClick: function () { setRegime("peakValley"); } }, "峰谷价"),
              el("button", { style: segBtn2, onClick: function () { setRegime("base"); } }, "基础价")
            ),
        ...
        tab === "overview" ? el(OverviewView, { records: records, regime: regime }) : null,
        tab === "calendar" ? el(CalendarView, { records: records, regime: regime, days: data.days || [] }) : null,
        tab === "cache" ? el(CacheListView, { records: records, regime: regime }) : null,
