  ...
  factory: (require) => {
    ...
    function BalancePanel() {
      ...
      var providers = [
        ...
        { id: "siliconflow", name: "SiliconFlow", hint: "SILICONFLOW_API_KEY（推理 Key）" },
        { id: "digitalocean", name: "DigitalOcean", hint: "DIGITALOCEAN_TOKEN（账户级 Token，不是 DO AI 推理 Key）" },
        { id: "amd-gpu-cloud", name: "AMD GPU Cloud", hint: "暂无公开余额 API", unsupported: true }
      ];
      ...
      return el("div", { style: st.root },
        ...
        s.status === "error"
          ? el("div", { style: st.errbox },
              el("div", { style: st.errboxTitle }, d && d.unsupported ? "暂不支持直接查询" : "查询失败"),
              el("div", null, s.error),
        ...
        d && d.ok
          ...
          : null,
        d && d.ok ? el("div", { style: st.note }, d.sourceNote + (d.credentialName ? " 使用凭据 " + d.credentialName + "。" : "")) : null,
